...
独身（celibacy）を、性的活動が「ない」状態としてではなく、仏教・キリスト教・古典哲学に長い前史をもつ
**倫理的・実存的な選択**として捉え直す論文です。

議論は二段構えになっています。第一に、性的活動を倫理的に必要とみなす通説の根拠 —— 生殖がなければ社会は
存続しない —— は、生物学的な事実（記述）から個人の義務（規範）を導いており、この移行はベネターの
反出生主義の議論を前にすると持ちこたえない、と論じます。第二に、その前提を外したうえで、
エピクロスの快の区別（動的な快と、静的で安定した快）とショーペンハウアーの意志の形而上学を手がかりに、
**他者や欲望の周期に依存しない自足的な幸福**という観点から独身を積極的に評価します。

最後に四つの反論 —— 関係性の心理学から、反出生主義の自己論駁性から、神学的偏狭さの疑いから、
QOL 判断の主観性から —— を取り上げ、それぞれに応答します。結論は「独身が唯一正しい」ではなく、
**独身は説明を要する欠落ではなく、擁護しうる自己陶冶の一つの範型である**というものです。
...
A parallel, secular version of the same structure appears already in classical philosophy, in the Aristotelian notion of schole (leisure) as the precondition of philosophical and civic virtue. For Aristotle, the person absorbed in the necessities of practical life — including, on some readings, the management of household and family — has less capacity for the contemplative activity that constitutes the highest form of eudaimonia. The celibate or unattached life, on this reading, is not aristocratic in a narrow sociological sense (a matter of inherited class privilege) but in the older sense the original paper gestures toward: a life organized around the cultivation of one's own capacities rather than around obligations imposed by reproduction and household management.
...
Aquinas, T. (1265–1274/1947). Summa Theologica (Fathers of the English Dominican Province, Trans.). Benziger Brothers.

Aristotle. (c. 350 BCE/2009). Nicomachean Ethics (D. Ross, Trans., Rev. ed.). Oxford University Press.

Benatar, D. (2006). Better Never to Have Been: The Harm of Coming into Existence. Oxford University Press.

Diogenes Laertius. (3rd century CE/1925). Lives of Eminent Philosophers (R. D. Hicks, Trans.). Loeb Classical Library.

Foucault, M. (1976/1978). The History of Sexuality, Vol. 1: An Introduction (R. Hurley, Trans.). Pantheon Books.

Kant, I. (1785/1998). Groundwork of the Metaphysics of Morals (M. Gregor, Trans.). Cambridge University Press.

Schopenhauer, A. (1818/1966). The World as Will and Representation, Vol. 1 (E. F. J. Payne, Trans.). Dover Publications.

Schopenhauer, A. (1844/1966). The World as Will and Representation, Vol. 2, Ch. 44, "The Metaphysics of Sexual Love" (E. F. J. Payne, Trans.). Dover Publications.

The Holy Bible. 1 Corinthians 7 (any standard translation).
